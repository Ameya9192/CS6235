...
-- Run labeling.py on "sample_train/test_geo.txt" and save its output to sample_train/test_templab.txt. In sample_train/test_templab.txt, manually label '1' if relevant or '0' if otherwise, at end of each cell. Refer labels.txt for the exact labelling syntax. Add a tab not a space after ']'
